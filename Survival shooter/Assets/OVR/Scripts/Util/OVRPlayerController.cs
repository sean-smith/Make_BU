...
public class OVRPlayerController : MonoBehaviour
{
	...
	public virtual void UpdateMovement()
	{
		...
		float ratchetInfluence = SimulationRate * Time.deltaTime * Acceleration * 0.1f * MoveScale * MoveScaleMultiplier;		

		//Use keys to ratchet rotation
		if (Input.GetKeyDown(KeyCode.Q))
			euler.y -= RotationRatchet * rotateInfluence;
		...
		if (!SkipMouseRotation)
			...
			//euler.y += Input.GetKey(KeyCode.W) * rotateInfluence * 3.25f;
